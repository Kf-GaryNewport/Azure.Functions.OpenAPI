...
namespace Azure.Functions.OpenAPI.Sample.FunctionAppV1
{
    public static class Swagger
    {
        ...
        [ResponseType(typeof(void))]
        public static HttpResponseMessage RunA( [HttpTrigger(AuthorizationLevel.Anonymous, System.Net.WebRequestMethods.Http.Get,System.Net.WebRequestMethods.Http.Post)] HttpRequestMessage req)
        {
